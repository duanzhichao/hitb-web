              ...
              <div style="line-height:360px">
                <el-carousel :interval="4000" height="360px">
                  <el-carousel-item v-for="item in images" :key="item.src">
                    <div >
                      <!-- <el-image style="height: 360px;width: 705.6px;" :src="item.src" ></el-image> -->
              ...
              <div ref="docList" style="width:100%">
                <div v-for="(article, index) in news" :key="index">
                  <div class="text item news"
                    ...
                    <a :href="`/hospitals/doc?id=${article.id}`" class="doc href">
        ...
        <div class="first-card">
          <el-tabs v-model="loginTab">
            <el-tab-pane label="账号登录" name="first">
              ...
              <div style="margin-top:10px">
                <el-input placeholder="请输入密码" v-model="user.password" show-password v-on:keyup.enter="sumbit"></el-input>
              </div>
              <div style="margin-top:10px">
            ...
            <el-tab-pane label="微信扫码登录" name="second">
              <!-- <div class="box" id="login_container" style="margin:0 -25px;width:100%"></div> -->
              <wxlogin :appid="wxLoginObj.appid" :scope="wxLoginObj.scope" :redirect_uri="wxLoginObj.redirect_uri" style="margin:0 auto;width:100%" :href="wxLoginObj.href"></wxlogin>
            </el-tab-pane>
          </el-tabs>
        </div>
      </el-col>
        ...
        <div class="second-card">
          <div v-for="(article, index) in articles" :key="index" class="text item doc">
            <el-row type="flex" class="row-bg">
              <el-col :span="20">
                <a class="doc href" :href="`/hospitals/doc?id=${article.id}`">{{article.title}}</a>
              </el-col>
...
export default {
  ...
  data() {
    return {
      ...
      softData: [{
        ...
        image: 'https://jklf.hitb.com.cn/static/images/windows-hover.png',
        title: '掌上医助客户端',
        href: 'https://jklf.hitb.com.cn/download/Clinet_Setup_1.1.0.exe'
      }, {
      ...
      wxLoginObj: {
        ...
        scope: "snsapi_login",
        redirect_uri: encodeURI("https://jklf.hitb.com.cn/hospitals/wechat_login_redirect_page"),
        state: "aw",
        style: "black",
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      // const height = docList.value.offsetHeight
      // console.log(leftImage.value.offsetHeight)
      // leftImage.value.style.height = height
    })
  ...
  methods: {
    getArticleList() {
      apiRequest(this, 'get', '/servers/doc', { type: '新闻动态' }).then(res => {
        this.articles = res.data
      })
    },
    getNews() {
      apiRequest(this, 'get', '/servers/doc', { type: '最近更新' }).then(res => {
        this.news = res.data
      })
    },
    sumbit() {
